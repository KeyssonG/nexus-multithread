    ...
    public LoginResponse login(LoginRequest request) throws SQLException {
        ...
        try {
            ...
            if (kcToken != null) {
                ...
                return new LoginResponse(kcToken.getAccessToken(), kcToken.getExpiresAt(), false);
            }
        } catch (Exception e) {
        ...
        try {
            ...
            if (kcUserId != null) {
                ...
                log.info("keycloak_ad_migrated | userId={} username={}", user.getId(), user.getUsername());
                ...
                if (kcToken != null) {
                    ...
                    return new LoginResponse(kcToken.getAccessToken(), kcToken.getExpiresAt(), isInitialAccess);
                }
            }
        } catch (Exception e) {
